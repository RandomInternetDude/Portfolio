          ...
          <ReactLoading className="center-load" type={"bars"} color={"white"} />
            ...
            <Grid>
              <Cell col={4.5} phone={8}>
                ...
                For little over a year now I've been working on dynamic apis that create predictive analytics tools for the medical & financial sector. I encourage those who are curious to check out Ironsafe <a  className="link"href="https://www.trellance.com/ironsafe-data-extraction-platform/">here. </a>
